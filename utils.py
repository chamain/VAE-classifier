...
def load_tiny() :
    ...
    path = '/home/lchamain/chamain/VAE/imgcomp-cvpr-master/tiny/tiny-imagenet-200'
    num_classes = 200
...
def get_annotations_map():
    valAnnotationsPath = '/home/lchamain/chamain/VAE/imgcomp-cvpr-master/tiny/tiny-imagenet-200/val/val_annotations.txt'
...
# =============================================================================
        ...
        print('************************8targets:',targets_one_hot.shape)
