...
at data rate of 0.8 bpp. Our proposed VAE-based models show 65\%$-$99\% reductions in encoder size, x1.5-x13.1 improvements in inference speed and 25\%$-$99\% savings in power compared to baseline models. We further show that a simple decoder can reconstruct images
with 
